...
#
# Created: Sun Jun  8 03:39:36 2014
...
class Ui_nuevoProducto(object):
    def setupUi(self, nuevoProducto):
        ...
        self.Btn_add.setGeometry(QtCore.QRect(110, 430, 95, 31))
        self.Btn_add.setObjectName("Btn_add")
        self.Btn_cancel = QtGui.QPushButton(nuevoProducto)
        self.Btn_cancel.setGeometry(QtCore.QRect(250, 430, 95, 31))
        self.Btn_cancel.setObjectName("Btn_cancel")
        self.label = QtGui.QLabel(nuevoProducto)
        self.label.setGeometry(QtCore.QRect(40, 40, 67, 31))
        self.label.setObjectName("label")
        self.label_2 = QtGui.QLabel(nuevoProducto)
        self.label_2.setGeometry(QtCore.QRect(40, 80, 67, 31))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtGui.QLabel(nuevoProducto)
        self.label_3.setGeometry(QtCore.QRect(40, 120, 81, 31))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtGui.QLabel(nuevoProducto)
        self.label_4.setGeometry(QtCore.QRect(40, 230, 67, 31))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtGui.QLabel(nuevoProducto)
        self.label_5.setGeometry(QtCore.QRect(40, 270, 67, 31))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtGui.QLabel(nuevoProducto)
        self.label_6.setGeometry(QtCore.QRect(40, 310, 67, 31))
        self.label_6.setObjectName("label_6")
        self.codigo = QtGui.QLineEdit(nuevoProducto)
        self.codigo.setGeometry(QtCore.QRect(120, 40, 113, 31))
        self.codigo.setObjectName("codigo")
        self.nombre = QtGui.QLineEdit(nuevoProducto)
        self.nombre.setGeometry(QtCore.QRect(120, 80, 113, 31))
        self.nombre.setObjectName("nombre")
        self.color = QtGui.QLineEdit(nuevoProducto)
        self.color.setGeometry(QtCore.QRect(120, 230, 113, 31))
        self.color.setObjectName("color")
        self.precio = QtGui.QLineEdit(nuevoProducto)
        self.precio.setGeometry(QtCore.QRect(120, 270, 113, 31))
        self.precio.setObjectName("precio")
        self.marca = QtGui.QLineEdit(nuevoProducto)
        self.marca.setGeometry(QtCore.QRect(120, 310, 113, 31))
        self.marca.setObjectName("marca")
        self.imagenButton = QtGui.QPushButton(nuevoProducto)
        self.imagenButton.setGeometry(QtCore.QRect(136, 350, 81, 61))
        ...
        self.imagenLabel.setGeometry(QtCore.QRect(250, 260, 180, 150))
        ...
        self.descripcion.setGeometry(QtCore.QRect(120, 120, 200, 100))
        self.descripcion.setObjectName("descripcion")
        self.label_8 = QtGui.QLabel(nuevoProducto)
        self.label_8.setGeometry(QtCore.QRect(380, 240, 67, 21))
        font = QtGui.QFont()
        font.setWeight(75)
        font.setBold(True)
        ...
        self.line.setGeometry(QtCore.QRect(250, 250, 118, 3))
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName("line")
        self.borrarImagenButton = QtGui.QPushButton(nuevoProducto)
        self.borrarImagenButton.setGeometry(QtCore.QRect(400, 370, 40, 40))
