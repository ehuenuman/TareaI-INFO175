...
class Form (QtGui.QDialog):
    def __init__(self, code=None, parent=None):
        ...
        if (self.codi is None):
            ...
            self.dirI = self.ui.imagenButton.clicked.connect(
                self.examinarImagen
                )
        else:
            ...
            self.dirI = self.edit.imagenButton.clicked.connect(
                self.examinarImagen
                )
    ...
    def add_valores(self):
        ...
        if ingreso_valido is True:
            ...
            self.almacenarImagen(self.dirI, cod)
            self.reject()
        else:
    ...
    def examinarImagen(self):
        ...
        direccion_imagen = nueva_imagen[0][0]

        try:
            self.ui.setImageLabel(direccion_imagen)
        except:
            pass
        try:
            self.edit.setImageLabel(direccion_imagen)
        except:
            pass
